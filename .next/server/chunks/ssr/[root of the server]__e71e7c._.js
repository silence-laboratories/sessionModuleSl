...
async function setupMPCSession(ownerClient) {
    ...
    const networkSigner = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$sl$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["createSilenceLabsSigner"])();
    const keygenResponse = await networkSigner.generateKey([
        "secp256k1"
    ]);
    const primaryKey = keygenResponse[0];
    // Create Viem-compatible MPC account
    const mpcAccount = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$sl$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["createViemAccount"])(networkSigner, primaryKey.keyId, primaryKey.publicKey, 'secp256k1');
    ...
    const extendedClient = ownerClient.extend((await __turbopack_require__("[project]/node_modules/@biconomy/abstractjs/dist/_esm/index.js [app-ssr] (ecmascript, async loader)")(__turbopack_import__)).smartSessionCreateActions(sessionsModule));
    // Install module
...
async function createSessionClient(sessionData) {
    ...
    const useModule = (await __turbopack_require__("[project]/node_modules/@biconomy/abstractjs/dist/_esm/index.js [app-ssr] (ecmascript, async loader)")(__turbopack_import__)).toSmartSessionsValidator({
        account: client.account,
        signer: sessionData.mpcAccount,
        moduleData: sessionData.moduleData
    });
    return client.extend((await __turbopack_require__("[project]/node_modules/@biconomy/abstractjs/dist/_esm/index.js [app-ssr] (ecmascript, async loader)")(__turbopack_import__)).smartSessionUseActions(useModule));
}
}}),
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__e71e7c._.js.map