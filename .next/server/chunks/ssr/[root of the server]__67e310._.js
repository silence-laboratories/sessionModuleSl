...
async function setupMPCSession(ownerClient) {
    const { networkSigner, keygenResponse } = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$sl$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["createSilenceLabsSigner"])();
    if (!keygenResponse?.[0]) throw new Error("Invalid MPC key response");
    const mpcAccount = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$sl$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["createViemAccount"])(networkSigner, keygenResponse[0].keyId, keygenResponse[0].publicKey, 'secp256k1');
...
function Home() {
    ...
    const initializeSession = async ()=>{
        ...
        try {
            ...
            setStep(2);
            const { extendedClient, mpcAccount, keygenResponse } = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$biconomy$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["setupMPCSession"])(ownerClient);
            setStep(3);
            const functionSelector = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$viem$2f$_esm$2f$utils$2f$abi$2f$encodeFunctionData$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["encodeFunctionData"])({
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__67e310._.js.map