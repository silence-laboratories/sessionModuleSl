(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/_76f1d9._.js", {
...
async function installSmartSessionModule(nexusClient, sessionSigner) {
    const sessionsModule = (await __turbopack_require__("[project]/node_modules/@biconomy/abstractjs/dist/_esm/index.js [app-client] (ecmascript, async loader)")(__turbopack_import__)).toSmartSessionsValidator({
...
async function createSilenceLabsSigner() {
    ...
    const ephemeralPrivateKey = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$silencelaboratories$2f$walletprovider$2d$sdk$2f$dist$2f$index$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["generateEphPrivateKey"])("ed25519");
    const ephemeralPublicKey = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$silencelaboratories$2f$walletprovider$2d$sdk$2f$dist$2f$index$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getEphPublicKey"])(ephemeralPrivateKey, "secp256k1");
    ...
    const ephClaim = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$silencelaboratories$2f$walletprovider$2d$sdk$2f$dist$2f$index$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["EphKeyClaim"](ephId, ephemeralPublicKey, "secp256k1", 60 * 60);
...
function Home() {
    ...
    const sendTransaction = async ()=>{
        ...
        try {
            ...
            const nexusClient = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$biconomy$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createOwnerNexusClient"])();
            // 2. Create a Silence Labs signer (using our EOAAuth setup).
            const silenceLabsSigner = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$sl$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createSilenceLabsSigner"])();
            // 3. Install the smart sessions module with the Silence Labs signer.
            const { nexusSessionClient, sessionsModule } = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$biconomy$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["installSmartSessionModule"])(nexusClient, silenceLabsSigner);
            // 4. Create a dummy session key (for demo, we generate a random account).
            const { privateKeyToAccount, generatePrivateKey } = await __turbopack_require__("[project]/node_modules/viem/_esm/accounts/index.js [app-client] (ecmascript, async loader)")(__turbopack_import__);
            ...
            const smartSessionNexusClient = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$biconomy$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createSessionUsageClient"])();
            ...
            const txData = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$viem$2f$_esm$2f$utils$2f$abi$2f$encodeFunctionData$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["encodeFunctionData"])({
    ...
    const signDemoMessage = async ()=>{
        ...
        try {
            ...
            const sig = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$sl$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["signMessageWithSilenceLabs"])(demoMessage);
            setSignature(sig);
        } catch (error) {
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: [
            ...
            signature && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                children: [
                    "Message Signature: ",
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("code", {
                        children: signature
...
_s(Home, "xoXeo3ffAFEMgwsLbh1g+IpWKjA=");
_c = Home;
var _c;
...
//# sourceMappingURL=_76f1d9._.js.map